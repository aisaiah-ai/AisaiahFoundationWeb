              ...
              {screenshots.map((screenshot, index) => (
                ...
                >
                  <img 
                    src={screenshot.src} 
                    alt={screenshot.alt} 
                    className="rounded-2xl shadow-lg w-full h-96 object-contain bg-gray-100 dark:bg-gray-800 transform group-hover:scale-105 transition-transform duration-300"
                  />
